...
public:
    ...
    bool is_int_binary()
    {
        return (is_add() || is_sub() || is_mul() || is_div() || is_rem() || is_shl() || is_ashr())&& 
                (get_num_operand() == 2);
    }
...
public:
    ...
    static BinaryInst *create_shl(Value *v1, Value *v2, BasicBlock *bb, Module *m);
    static BinaryInst *create_ashr(Value *v1, Value *v2, BasicBlock *bb, Module *m);
