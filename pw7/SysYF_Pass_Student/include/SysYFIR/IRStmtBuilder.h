...
public:
    ...
    BinaryInst *create_ishl( Value *lhs, Value *rhs){ return BinaryInst::create_shl( lhs, rhs, this->BB_, m_);}
    BinaryInst *create_iashr( Value *lhs, Value *rhs){ return BinaryInst::create_ashr( lhs, rhs, this->BB_, m_);}
